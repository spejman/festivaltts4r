...
The project also includes a rails plugin (festivalttsOnRails) that let's you introduce speech easily into your Ruby on Rails applications. You can found it at the extras directory.
